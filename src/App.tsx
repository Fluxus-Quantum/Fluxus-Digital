...
const ContactSection = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      const res = await fetch('https://formspree.io/f/mjgjnrep', {
        method: 'POST',
        body: data,
                ...
                <form onSubmit={handleSubmit} className="space-y-4">
                  <div className="grid md:grid-cols-2 gap-4">
                    <div>
                      ...
                      <input type="text" name="nombre" required className="w-full px-5 py-4 bg-white/5 border border-white/10 rounded-2xl focus:border-brand-green outline-none transition-all text-sm" placeholder="Juan Pérez" />
                    </div>
                    <div>
                      <label className="block text-[10px] font-black uppercase tracking-widest text-gray-500 mb-2">Empresa</label>
                      <input type="text" name="empresa" required className="w-full px-5 py-4 bg-white/5 border border-white/10 rounded-2xl focus:border-brand-green outline-none transition-all text-sm" placeholder="Mi Negocio" />
                    </div>
                  </div>
                  <div>
                    <label className="block text-[10px] font-black uppercase tracking-widest text-gray-500 mb-2">WhatsApp</label>
                    <input type="tel" name="whatsapp" required className="w-full px-5 py-4 bg-white/5 border border-white/10 rounded-2xl focus:border-brand-green outline-none transition-all text-sm" placeholder="+57..." />
                  </div>
                  <div>
                    <label className="block text-[10px] font-black uppercase tracking-widest text-gray-500 mb-2">Propósito</label>
                    <select name="proposito" className="w-full px-5 py-4 bg-white/5 border border-white/10 rounded-2xl focus:border-brand-green outline-none transition-all text-sm appearance-none">
...
const SocialFloatingButtons = () => {
  return (
    <div className="fixed bottom-6 left-6 z-50 flex flex-col gap-3">
      <motion.a
        href="https://www.instagram.com/fluxusdigital.tni/"
        target="_blank"
        rel="noopener noreferrer"
        initial={{ scale: 0, opacity: 0 }}
        animate={{ scale: 1, opacity: 1 }}
        ...
        whileHover={{ scale: 1.1 }}
        className="group relative w-12 h-12 rounded-full flex items-center justify-center shadow-2xl"
        style={{ background: 'radial-gradient(circle at 30% 107%, #fdf497 0%, #fdf497 5%, #fd5949 45%, #d6249f 60%, #285AEB 90%)' }}
      >
        <div className="absolute -top-10 left-0 bg-white text-gray-800 py-1 px-3 rounded-lg text-xs font-bold shadow-lg opacity-0 group-hover:opacity-100 transition-opacity whitespace-nowrap border border-gray-100 pointer-events-none">
          Instagram
        </div>
      ...
      <motion.a
        href="https://www.facebook.com/profile.php?id=61588961161138"
        target="_blank"
        rel="noopener noreferrer"
        initial={{ scale: 0, opacity: 0 }}
        animate={{ scale: 1, opacity: 1 }}
      ...
      <motion.a
        href="https://www.linkedin.com/in/ricardolopez-fq"
        target="_blank"
        rel="noopener noreferrer"
        initial={{ scale: 0, opacity: 0 }}
        animate={{ scale: 1, opacity: 1 }}
        ...
        <div className="grid md:grid-cols-4 gap-12 mb-16">
          <div className="col-span-1 md:col-span-2">
            ...
            <div className="flex gap-4">
              <a href="https://www.instagram.com/fluxusdigital.tni/" target="_blank" rel="noopener noreferrer" className="w-10 h-10 bg-white/5 rounded-xl flex items-center justify-center hover:bg-brand-green hover:text-brand-dark transition-all"><Instagram size={20} /></a>
              <a href="https://www.facebook.com/profile.php?id=61588961161138" target="_blank" rel="noopener noreferrer" className="w-10 h-10 bg-white/5 rounded-xl flex items-center justify-center hover:bg-brand-green hover:text-brand-dark transition-all"><Facebook size={20} /></a>
              <a href="https://www.linkedin.com/in/ricardolopez-fq" target="_blank" rel="noopener noreferrer" className="w-10 h-10 bg-white/5 rounded-xl flex items-center justify-center hover:bg-brand-green hover:text-brand-dark transition-all"><Linkedin size={20} /></a>
            </div>
          </div>
